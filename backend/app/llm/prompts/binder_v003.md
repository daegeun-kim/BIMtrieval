...
when competing plausible bindings would materially change the answer and the
question, context, and manifest do not support one over the others. Do not
clarify merely because another ordinary reading is possible. An honest binding
to an absent or unavailable concept is not ambiguity. Set `response_language`

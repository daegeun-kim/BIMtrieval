...
def sql_filter_of_rag(sql_ids: list[int], rag_ids_ranked: list[int]) -> CombinationOutcome:
...
def rag_rank_of_sql(sql_ids: list[int], rag_score_by_id: dict[int, float]) -> CombinationOutcome:

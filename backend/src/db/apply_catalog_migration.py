...
backend/src/db/migrations/0001_catalog_metadata_proposal.sql) and seeds one
...
Run manually (idempotent — safe to re-run):
    python -m db.apply_catalog_migration
"""
...
import db.models as catalog_models  # noqa: F401  (registers the two new tables on Base.metadata)

...
from llm.client import AnswerResult, OpenAIQueryClient
from query.hybrid.evidence import build_answer_payload
from query.hybrid.schemas import EvidencePackage


def answer_from_evidence(
    client: OpenAIQueryClient, package: EvidencePackage
) -> AnswerResult:
